...
# Grouping
XXXX=DATA_ALL[DATA_ALL['pdbid'].isin(Train_Proteins)]
dtrain.set_group( np.array(list(XXXX['pdbid'].value_counts())) )
del XXXX
...
col_sample_rates = [0.5, 0.7, 1]
subsamples = [1]
etas = [0.01, 0.1 , 0.3]
max_depths = [3, 6, 9]
reg_alphas = [0, 0.1 , 10] # Inactive
reg_lambdas = [1, 0.1 , 10] # Inactive
ntrees = [100, 1000]
# col_sample_rates = [1]
# subsamples = [1]
# etas = [0.01,0.1]
# max_depths = [6]
# reg_alphas = [0] # Inactive
# reg_lambdas = [1] # Inactive
# ntrees = [100, 1000]
